function randomVerbs(request, response){
    ...
    response.json([
        ...
        {id:4, name:'To appear', traducao:'Aparecer',  exemplo:'Perhaps to appear more often in results lists.', tradExemplo: 'Talvez seja para aparecer mais vezes nas listas de resultados.', simplePast:'appeared', simplePastModel:'appear + ed', simplePastTrad:'Apareceu', simplePastExample:'They appeared on TV.', simplePastExampleTrad:'Eles apareceram na TV.'},
